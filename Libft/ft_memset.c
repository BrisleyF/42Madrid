...
// La funcion memsetr representa un puntero genérico que puede apuntar a
// cualquier tipo de dato, con el proposoto de retornar dicho puntero.
...
// variable c. Tambien relacionado a cantidad de memoria en bytes que va a
// modificar.
//
...
// se asigne el valor de la variable c y de una vez se hace un cambio del tipo
// de dato (casteo) para tener coincistencia con el tipo de dato de *s.
